...
![Vidéo de présentation](https://github.com/Slyss41/Dracoon/blob/main/miniature-pr%C3%A9sentation.png)
...
3. Activer les notifications sur vos comptes Dofus (option en jeu > général > notification en arrière plan) [screen](https://github.com/Slyss41/Dracoon/blob/main/activer-notification-ig.png)
4. Activer les notifications Windows (Paramètre > Système > Actions et notifications > "activer"
5. Désactiver "autoriser les notifications à émettre des sons" (ou le faire spécifiquement pour Dofus si vous voulez garder le son pour les autres applications) [screen](https://github.com/Slyss41/Dracoon/blob/main/activer-notification-windows1.png)
6. Cliquer sur l'application "Dofus 1" pour désactiver l'affichage des bannières. Vous pouvez donc désactiver le son des notifications de Dofus à cet endroit (si vous préférez avoir le son des autres notifications) [screen](https://github.com/Slyss41/Dracoon/blob/main/activer-notification-windows2.png)
